    ...
    <>
      <section className="mx-auto max-w-6xl px-6 py-24 text-center">
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
          <Link
            href="/protocol"
            className="rounded-md bg-cyan-500 px-5 py-3 text-sm font-semibold text-black hover:bg-cyan-400"
          >
            Read the protocol
          </Link>
          <Link
            href="/developers"
            className="rounded-md border border-white/20 px-5 py-3 text-sm font-semibold text-white hover:border-cyan-400"
          >
            Start building
          </Link>
        </div>
