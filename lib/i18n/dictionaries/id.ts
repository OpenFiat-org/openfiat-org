...
export const id: Dictionary = {
  ...
  pages: {
    ...
    downloads: {
      ...
      title: "Unduhan",
      intro:
        "Render PDF whitepaper per bab. Tak ada PDF spesifikasi OFS — bacalah di situs atau di repositori spesifikasi.",
    },
    documentation: {
      eyebrow: "dokumentasi",
      title: "Dokumentasi",
    ...
    status: {
      ...
      title: "Status",
      intro:
        "Status jaringan dan layanan. Belum ada jaringan publik yang berjalan, jadi tak ada yang perlu dilaporkan.",
    },
    contact: {
      eyebrow: "kontak",
      title: "Kontak",
