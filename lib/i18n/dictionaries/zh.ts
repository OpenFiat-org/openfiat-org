...
export const zh: Dictionary = {
  ...
  home: {
    ...
    saleBand: {
      ...
      bodyLive:
        "OPEN 是维系市场诚信的每一种角色——商户、仲裁者、节点、预言机——背后的质押品。预售在任何公开销售之前，以固定价格提供社区分配额度。预售已在 devnet 上线；今天连接钱包即可参与认购。",
      presaleRate: "预售价格",
      publicRate: "后续公开销售",
  ...
  sale: {
    ...
    txSuccess: "已确认",
    errors: {
      amountRequired: "请输入认购金额。",
      amountInvalid: "请输入大于零的金额。",
      insufficientBalance:
        "您有 {balance} {symbol}，请输入余额足以支付的金额。",
      belowMinimum: "钱包的首次认购金额不得低于 {min} USDC。",
      aboveMaximum: "每个钱包累计认购上限为 {max} USDC。",
      hardCapReached: "本次销售已达上限，无法继续认购。",
      saleNotOpen: "销售当前未开放。",
      claimsNotOpen: "销售结算完成后方可领取。",
      nothingToClaim: "您没有可领取的 OPEN。",
      walletBanned: "此钱包无法参与本次销售。",
      walletRejected: "您在钱包中取消了该请求。",
      notEnoughSol: "您的 SOL 不足以支付网络手续费。",
      expired: "请求在确认前已过期，请重试。",
      slippage: "兑换过程中价格波动过大，请重试。",
      network: "无法连接网络，请检查网络后重试。",
      generic: "出现问题，本次购买未完成。",
      detailsLabel: "技术详情",
    },
    claim: "领取 OPEN",
    swapNotice:
